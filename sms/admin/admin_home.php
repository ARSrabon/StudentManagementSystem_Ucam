        ...
        <nav>
            <div class="container">
                <ul>
                    ...
                    <li class='sub-menu'> <a href="../profile.php">Account<i class='fa fa-angle-down'></i></a>
                        <ul>
                            <li><a href="../profile.php?profile=1">Profile</a></li>
                            <li><a href="../profile.php?profile=1">Change Password</a></li>
                        </ul>
                </ul>
            </div>
        </nav>
